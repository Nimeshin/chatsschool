...
<main class="vacancy-page">
    ...
    <!-- Mathematics Teacher Vacancy Section -->
    <section class="vacancy-details py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h2 class="card-title h4 text-primary mb-4">Level 1 Post: Intermediate Phase Educator (Mathematics)</h2>
                            <div class="alert alert-info">
                                <strong>Closing Date:</strong> 07th May 2025
                            </div>
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    B.ED degree with specialized learning area in Mathematics
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    Minimum 3 years teaching experience
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Create and achieve a Sri Sathya Sai Model School environment
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Integrate the five human values (Truth, Right Conduct, Peace, Love and Non-Violence) in daily teaching
                                ...
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Provide experiential and transformational education
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Foster self-discipline, self-sacrifice, and selfless service
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Promote unity of faiths and holistic development
                                </li>
                            </ul>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    <a href="assets/vacancies/Job Advert And Department For Level 1 Mathematics 2025.pdf" class="btn btn-outline-primary w-100" target="_blank">
                                        <i class="fa-solid fa-file-pdf me-2"></i>
                                        Job Description
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="assets/vacancies/Application Form For Mathematics.pdf" class="btn btn-outline-primary w-100" target="_blank">
                                        <i class="fa-solid fa-file-pdf me-2"></i>
                                        Application Form
                                    </a>
                                </div>
    ...
    <!-- English Teacher Vacancy Section -->
    <section class="vacancy-details py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h2 class="card-title h4 text-primary mb-4">Level 1 Post: Intermediate Phase Educator (English)</h2>
                            <div class="alert alert-info">
                                <strong>Closing Date:</strong> 05th May 2025
                            </div>
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    B.ED degree with specialized learning area in English
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    Minimum 3 years teaching experience
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Integrate the five human values in daily teaching and activities
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Provide experiential and transformational education
                                ...
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Foster self-discipline and selfless service
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Promote unity of faiths and holistic development
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    <a href="assets/vacancies/Job Advert and Description For Level 1 English 2025.pdf" class="btn btn-outline-primary w-100" target="_blank">
                                        <i class="fa-solid fa-file-pdf me-2"></i>
                                        Job Description
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="assets/vacancies/Application Form for English Educator.pdf" class="btn btn-outline-primary w-100" target="_blank">
                                        <i class="fa-solid fa-file-pdf me-2"></i>
                                        Application Form
                                    </a>
                                </div>
    ...
    <!-- Current Vacancy Section - Afrikaans Teacher -->
    <section class="vacancy-details py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h2 class="card-title h4 text-primary mb-4">Level 1 Post: Intermediate Phase Educator (Afrikaans)</h2>
                            <div class="alert alert-info">
                                <strong>Closing Date:</strong> 2nd May 2025
                            </div>
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    B.ED degree with specialized learning area in Afrikaans
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    Minimum 3 years teaching experience
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Engage in classroom teaching integrating secular education with Sri Sathya Sai Educare
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Create an environment fostering the five human values
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Implement Sri Sathya Sai pedagogy of Integral Education
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Coordinate extra and co-curricular activities
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    <a href="assets/vacancies/Job Advert For Afrikaans Teacher.pdf" class="btn btn-outline-primary w-100" target="_blank">
                                        <i class="fa-solid fa-file-pdf me-2"></i>
                                        Job Description
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="assets/vacancies/Application Form for Afrikaans Educator.pdf" class="btn btn-outline-primary w-100" target="_blank">
                                        <i class="fa-solid fa-file-pdf me-2"></i>
                                        Application Form
                                    </a>
                                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h2 class="card-title h4 text-primary mb-4">Level 1 Post: Intermediate Phase Educator (Social Science and Natural Science)</h2>
                            <div class="alert alert-info">
                                <strong>Closing Date:</strong> 26th April 2025
                            </div>
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    B.ED degree with specialized learning area
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    Minimum 3 years teaching experience
                                ...
                                <li class="mb-2">
                                    <i class="fa-solid fa-check text-primary me-2"></i>
                                    Specialization in Social Science and Natural Science
                                </li>
                            </ul>
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Integrate secular education with Sri Sathya Sai Educare principles
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Create an environment fostering human values (Truth, Right Conduct, Peace, Love, Non-Violence)
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Promote curricular, extra-curricular, and co-curricular activities
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Foster the tripartite relationship between teacher, parent, and child
                                </li>
                                <li class="mb-2">
                                    <i class="fa-solid fa-circle-check text-primary me-2"></i>
                                    Provide experiential and transformational education
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    <a href="assets/vacancies/Job Advert and Description For Level 1-2025.pdf" class="btn btn-outline-primary w-100" target="_blank">
                                        <i class="fa-solid fa-file-pdf me-2"></i>
                                        Job Description
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="assets/vacancies/Employment Application Intermediate 01-2025.pdf" class="btn btn-outline-primary w-100" target="_blank">
                                        <i class="fa-solid fa-file-pdf me-2"></i>
                                        Application Form
                                    </a>
                                </div>
